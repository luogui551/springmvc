...
import com.aires.base.util.GenericSupport;
/**
 * 
 * @author aires
...
public abstract class SpringBasedHibernateDao<T> extends GenericSupport<T> implements IHibernateDao<T> {
	...
	public int del(String id) {
		return update("delete from " + this.getGenericClass().getName() + " where id = ?" , id);
	}
	...
	public int del(String[] ids) {
		...
		return update("delete from " + this.getGenericClass().getName() + " where id in (" + tmp + ")", (Object[])ids);
	}
	...
	public T queryById(String id) {
		return template.get(this.getGenericClass(), id);
	}	
...
//-----------------------------------------------------------------------------------------------------------
	...
	@Override
	public List<Object[]>sqlList(String sql, Object...params){
		return sqlList(-1, 0, sql, params);
	}
	
	@Override
	public List<Object[]>sqlList(int start, int limit, String sql, Object...params){
